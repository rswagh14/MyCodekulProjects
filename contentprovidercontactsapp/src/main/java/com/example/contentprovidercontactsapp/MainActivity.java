package com.example.contentprovidercontactsapp;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (ContextCompat.checkSelfPermission(this, Manifest.permission.READ_CONTACTS) !=
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(this, Manifest.permission.READ_CONTACTS)) {
                ...
                builder.setMessage("Contact Permission Grant Request").setPositiveButton("Okay", (d, w) -> {

                    ActivityCompat.requestPermissions(this,
                            new String[]{Manifest.permission.READ_CONTACTS}, PERMISSION_CONTACT);
                })
                        .setNegativeButton("No", (dialog, w) -> {
                            dialog.dismiss();
                        });
    ...
    private void fetchContacts(){
        ...
        while(cursor.moveToNext()){
            ...
            Log.i("@Rahul ","Name "+name+" Number "+num);
            contacts.add(name+"\n"+num);
        }
