...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String KEY_SAMPLE_INT = "sample int" ;
    ...
    private void saveData() {
        ...
        SharedPreferences sharedpref = getSharedPreferences("my",MODE_APPEND);
    ...
    private void readData() {
        ...
        int sampleint = sharedPrefs.getInt(KEY_SAMPLE_INT,1);
